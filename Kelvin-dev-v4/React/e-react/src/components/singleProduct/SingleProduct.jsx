...
function SingleProduct() {
  const { product, getProductById } = useContext(GlobalContext);
  const { productId } = useParams();
  let productIdUse = productId.replace(":", "");
  console.log(productIdUse);

  useEffect(() => {
    //make call to get the product with the current Id
    if (!product || product.id != productIdUse) {
      getProductById(productIdUse);
    }
  }, [product]);
          ...
          <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
              ...
              <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                <div class="flex items-end">
                  <h1 class="text-3xl font-bold">
                    {product ? product.price.replace("NGN", "$") : ""}
                  </h1>
            ...
            <div class="lg:col-span-3">
              ...
              <div class="mt-8 flow-root sm:mt-12">
                ...
                <p class="mt-4">{product ? product.desc : ""}</p>
